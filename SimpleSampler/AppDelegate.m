...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if (_is_iPhone4) {
        ...
        viewController = [storyboard instantiateViewControllerWithIdentifier:@"PlayViewController"];
    }else if (_is_iPad) {
        UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Main3" bundle:nil];
        viewController = [storyboard instantiateViewControllerWithIdentifier:@"PlayViewController"];
    }else {
